...
public class HibernateAccessorReflectionMultiValueReader implements HibernateAccessorMultiValueReader {

	private final HibernateAccessorValueReader<?>[] readers;

	public HibernateAccessorReflectionMultiValueReader(HibernateAccessorValueReader<?>[] readers) {
