 ...
 */
package org.hibernate.models.jdk;
...
import org.hibernate.models.jdk.internal.AbstractJdkAnnotationTarget;
...
import static org.hibernate.models.jdk.JdkBuilders.buildMethodDetails;
...
public class JdkClassDetails extends AbstractJdkAnnotationTarget implements ClassDetailsSupport {
	...
	public boolean isPrimitive() {
		return managedClass.isPrimitive();
	}
	...
	public ModuleDetails getModule() {
		final Module module = managedClass.getModule();
		if ( !module.isNamed() ) {
			return null;
		}
