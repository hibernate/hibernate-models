...
public class PrimitiveTypeTests {
	...
	void testWithJandex() {
		...
		final SourceModelBuildingContextImpl buildingContext = createBuildingContext( jandexIndex );
		verify( buildingContext.getClassDetailsRegistry() );
	}

	@Test
	void testWithoutJandex() {
		final SourceModelBuildingContextImpl buildingContext = createBuildingContext( (Index) null );
		verify( buildingContext.getClassDetailsRegistry() );
	}
